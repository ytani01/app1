...
8. **Commit Code Changes:**
   ...
   - Perform the commit.
   **NOTE: このプロジェクトでは、コミットは各タスク完了時ではなく、各フェーズ完了時にまとめて行われます。各タスク完了時には、作業を一時保存してください。**

9. **Attach Task Summary with Commit Message:**
   - **Step 9.1: Draft Commit Message:** Create a detailed commit message for the completed task. This should include the task name, a summary of changes, a list of all created/modified files, and the core "why" for the change.
   - **Step 9.2: Commit Changes:** Perform the commit.
